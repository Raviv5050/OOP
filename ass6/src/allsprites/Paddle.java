...
/**
 * @author Raviv
 * The allsprites.Paddle class is the player in the game. It is a rectangle that is controlled by the
 * arrow keys, and moves
 * according to the player key presses. It should implement the all.interfaces.Sprite and
 * the all.interfaces.Collidable interfaces.
...
public class Paddle implements Sprite, Collidable {
    ...
    public void moveLeft() {
        ...
        if (keyboard.isPressed(KeyboardSensor.LEFT_KEY)) {
            ...
            if (paddleUpperLeft.getX() - PADDLE_LEFT_CHANGE >= GameLevel.BOTTOM_BLOCK_START_WIDTH) {
    ...
    public void moveRight() {
        ...
        if (keyboard.isPressed(KeyboardSensor.RIGHT_KEY)) {
            ...
            if (paddleUpperLeft.getX() + PADDLE_RIGHT_CHANGE
                    <= GameLevel.BOTTOM_BLOCK_WIDTH - paddleRectangle.getWidth()) {
    ...
    /**
     * timePassed --   all.interfaces.Sprite- check if the "left" or "right" keys are pressed, and if
     * so move the paddle accordingly.
     */
