...
import buildgame.CollisionInfo;
import buildgame.GameLevel;
import buildgame.GameEnvironment;
import shapes.Line;
import shapes.Point;
 ...
 * The allsprites.Ball class implementing the all.interfaces.Sprite interface.
 */
public class Ball implements Sprite {
    ...
    public void drawOn(DrawSurface surface) {
        ...
        //setting the color to color black for the drawCircle
    ...
    /**
     * removeFromGame -- remove the ball from the game, calling the appropriate game methods.
     *
     * @param game the game of this ball.
     */
    ...
    public void changeDirectionByBlock() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (collisionInfo != null) {
                ...
                this.velocity = object.hit(this, currentCollisionPoint, this.velocity);
