...
/**
 * @author Raviv
 * The class receive a new ArrayList whose elements type is also all.interfaces.Collidable
 * and make collidables point to it.
 */
...
public class GameEnvironment {
    ...
    /**
     * constructor that create ArrayList whose elements type is also all.interfaces.Collidable
     * and make collidables point to it.
     */
    ...
    /**
     * removeCurrentCollidable -- remove the current given collidable from the environment.
     *
     * @param c the collidable that should be removed.
     */
    public void removeCurrentCollidable(Collidable c) {
