...
public class TestBlock {
    ...
    static private void drawAnimation(Point start, double dx, double dy) {
        ...
        ball.getGame().addCollidable(b1);
        ball.getGame().addCollidable(b2);
        ball.getGame().addCollidable(b3);
        ball.getGame().addCollidable(b4);
        ball.getGame().addCollidable(b5);
        ball.getGame().addCollidable(b6);
        ball.getGame().addCollidable(b7);
        ball.getGame().addCollidable(b8);
        ball.getGame().addCollidable(b9);
        ball.getGame().addCollidable(b10);

        Velocity v = Velocity.fromAngleAndSpeed(10, 20);
        ball.setVelocity(v);
