public class LineFinalTest {
    ...
    public static void main(String[] args) {
        ...
        Line l101 = new Line(1, 1, 2, 2);

        Line l102 = new Line(3, 3, 2, 2);

        Line l103 = new Line(1.1, 0, 1.1, 1.1);

        Line l104 = new Line(0, 1.75, 2, 1.75);

        Line l105 = new Line(2.5, 2.5, 2.5, 2.5);

        if (!l101.intersectionWith(l102).equals(new Point(2, 2))) {
        ...
        if (l102.isIntersecting(l104) || l102.intersectionWith(l104) != null) {
        ...
        if (l103.isIntersecting(l104) || l103.intersectionWith(l104) != null) {
        ...
        if (!l101.middle().equals(new Point(1.5, 1.5)) || !l102.middle().equals(new Point(2.5, 2.5))) {
        ...
        if (!l105.intersectionWith(l102).equals(l105.start())) {
