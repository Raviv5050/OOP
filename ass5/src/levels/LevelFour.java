...
/**
 * @author Raviv
 * The class present the fourth level.
...
public class LevelFour implements LevelInformation {
    ...
    private static final double ANGLE_BALL1 = 330;
    private static final double SPEED_BALL1 = 5;
    private static final double ANGLE_BALL2 = 1;
    private static final double SPEED_BALL2 = 5;
    private static final double ANGLE_BALL3 = 30;
    private static final double SPEED_BALL3 = 5;
    ...
    private static final Point UPPER_LEFT_BLOCK = new Point(380, 250);
    ...
    public static final double BLOCKS_WIDTH = 47.467;
    ...
    public List<Block> blocks() {
        ...
        //array of colors
        Color[] colorArray = {Color.lightGray, colorRed, colorOrange, colorYellow, Color.GREEN, colorBlue, colorPink};
        double pointX;
        double pointY;
        for (int i = 0; i < colorArray.length; i++) {
            for (int j = 0; j <= (2 * colorArray.length) + 1; j++) {
