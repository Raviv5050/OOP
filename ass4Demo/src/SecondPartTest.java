...
public class SecondPartTest {
    ...
    public static void main(String[] args) {
        ...
        e[9] = new Mult(new Var("x"), new Num(1.0));
        System.out.println("checkNew:  " + e[9].simplify());
        ...
        Expression e14 = new Div(new Plus(new Mult(new Num(0.0), new Var("x")),
                new Mult(new Num(1.0), new Num(0.0))), new Num(1.0));
        System.out.println("checkNew e14   (0*x + 1*0) / 1:  " + e14.simplify());

        Map<String, Double> assignmentNeg = new TreeMap<String, Double>();
        assignmentNeg.put("w", 2.0);

        Expression e15 = new Var("e");
        try {
            System.out.println("checkNew e15   e:  " + e15.evaluate(assignmentNeg));
        } catch (Exception ex) {
        ...
        for (int i = 0; i < e.length; i++) {
            ...
            System.out.println("Expression " + (i) + " : " + e[i].simplify().toString());
            try {
