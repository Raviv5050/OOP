...
*********************
CHECK NUM
check evaluate (should return 2.0): 2.0
num.getVariables returns empty list (its ok)
check toString (should return 2.0): 2.0
check assign (should return 2.0): 2.0

*********************
CHECK VAR
check evaluate (should return 2.0): 2.0
check getVariables (should return x): x
check toString (should return x): x
check assign (should replace x by 5.0): 5.0
check assign (should return x): x

*********************
CHECK PLUS
check evaluate (should return 7.0): 7.0
check getVariables (should print x, y):
x
y
check toString (should return (x + y)): (x + y)
check assign (should replace x by 3.0): (3.0 + y)
check assign  (should replace y by 4.0): (x + 4.0)
check assign (should return (x + y)): (x + y)

*********************
CHECK MINUS
check evaluate (should return -7.5): -7.5
check getVariables (should print x, y):
x
y
check toString (should return (x - y)): (x - y)
check assign (should replace x by 2.0): (2.0 - y)
check assign  (should replace y by 1.0): (x - 1.0)
check assign (should return (x - y)): (x - y)

*********************
CHECK PLUS + MINUS (MULTI EXPRESSION)
check evaluate (should return 17.5): 17.5
check getVariables (should print x, y, z):
x
y
z
check toString (should return ((((x + y) - z) + y) + ((x + y) - z)) ): ((((x + y) - z) + y) + ((x + y) - z))
check assign (should replace x by 3.0): ((((3.0 + y) - z) + y) + ((3.0 + y) - z))
check assign  (should replace y by 4.0): ((((x + 4.0) - z) + 4.0) + ((x + 4.0) - z))
check assign  (should replace z by 6.5): ((((x + y) - 6.5) + y) + ((x + y) - 6.5))
check assign (should return original): ((((x + y) - z) + y) + ((x + y) - z))

*********************
CHECK MULT
check evaluate (should return 15.0): 15.0
check getVariables (should print x, y):
x
y
check toString (should return (x * y)): (x * y)
...
*********************
CHECK DIV
check evaluate (should return 5.0): 5.0
check getVariables (should print x, y):
x
y
check toString (should return (x / y)): (x / y)
...
*********************
CHECK POW
check evaluate (should return 125.0): 125.0
check getVariables (should print x, y):
x
y
check toString (should return (x^y)): (x^y)
...
*********************
CHECK LOG
check evaluate (should return 3.0): 3.0
check getVariables (should print x, y):
x
y
check toString (should return log(x, y)): log(x, y)
check assign (should replace x by 2.0): log(2.0, y)
check assign  (should replace y by 1.0): log(x, 1.0)
check assign (should return log(x, y)) ): log(x, y)

*********************
CHECK SIN
check evaluate (should return 1.0): 1.0
check getVariables (should print x):
x
check toString (should return sin(x)): sin(x)
check assign (should replace x by 45.0): sin(45.0)
check assign (should return sin(x)) ): sin(x)

*********************
CHECK COS
check evaluate (should return ~0): 0.0
check getVariables (should print x):
x
check toString (should return cos(x)): cos(x)
check assign (should replace x by 45.0): cos(45.0)
check assign (should return cos(x)) ): cos(x)

*********************
CHECK NEG
check evaluate (should return -8.0): -8.0
check getVariables (should print x, y, u, v, z):
u
v
x
y
z
check toString (should return (-((cos(x) + sin(y))^log((u * v), z))) ): (-((cos(x) + sin(y))^log((u * v), z)))
check assign (should replace x by 45.0): (-((cos(45.0) + sin(y))^log((u * v), z)))
check assign (should replace z by 4.0 ): (-((cos(x) + sin(y))^log((u * v), 4.0)))
