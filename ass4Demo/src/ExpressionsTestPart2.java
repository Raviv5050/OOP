...
public class ExpressionsTestPart2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("test 18  de:  toString" + de.toString());
            de = de.assign("x", new Num(4));
            System.out.println("test 18  de after assign:  toString" + de.toString());

            value = de.evaluate();
            System.out.println("test 18  value:  toString" + value);
            if (value == 2621440) {
                gradePart2++;
